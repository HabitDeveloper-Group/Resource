...
| -------- | ------ | -------- | ------ | -------- | ------ |
|     含义 |   主键 | 用户名(唯一) | 昵称 |    密码   |   积分 |

## 2、习惯表tb_habits
|   字段名  |  id | habit_name | icon |  tag |  description |earliest_time | lastest_time|lower_limit| added_time|
| -------- | ------ | -------- | ------ | -------- | ------ | ------ | -------- | ------ |------ |
|     含义 |   主键 | 习惯名(唯一) | 图标链接 |   标签  |  描述 | 最早打卡时间 | 最晚打卡时间 | 最小打卡次数 | 被添加的日期|当日完成次数
