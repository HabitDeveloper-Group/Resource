...
## 2、习惯表tb_habits
|   字段名  |user_id|  habit_id | habit_name | icon |  tag |  description |earliest_time | lastest_time|lower_limit| added_time|
| -------- | -------| ------ | -------- | ------ | -------- | ------ | ------ | -------- | ------ |------ |
|     含义 |  用户id|习惯id | 习惯名 | 图标链接 |   标签  |  描述 | 最早打卡时间 | 最晚打卡时间 | 最小打卡次数 | 被添加的日期|当日完成次数
|     约束 |  primaryKey|primaryKey | unique|  not null  |   not null  | default  | default 00:00 | default 24:00 | default 1 | not null|default 0
